...
export default function PurchaseOrders() {
  ...
  return (
    <div>
      ...
      {(user?.role === "Supervisor" && showCreateForm) && (
          ...
          <div className="modal">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex gap-2 mt-4">
                <button type="submit" className="btn btn-primary flex-1">Submit Order</button>
                <button type="button" className="btn btn-secondary flex-1" onClick={() => setShowCreateForm(false)}>Cancel</button>
              </div>
