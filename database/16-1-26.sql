...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4901d208-f29b-11f0-993e-2c58b9de6848:1-144';
...
INSERT INTO `organizations` VALUES (1,'Team',NULL,NULL,'0',NULL,'2026-01-16 12:07:36','2026-01-16 14:24:33'),(2,'LJ University',NULL,'18K2U','1','IPOZZ','2026-01-12 07:31:23','2026-01-16 12:12:40');
...
INSERT INTO `users` VALUES (1,'Aarav Patel','log@gmail.com','log123','software developer','Design','9876543210','T1981','',1,NULL,NULL,'2026-01-10 19:00:21','2026-01-16 12:13:31'),(2,'Admin User','admin@gmail.com','admin123','Super Admin','admin','9904888108','2DXFU','18K2U',2,NULL,NULL,'2026-01-16 06:09:47','2026-01-16 12:14:00');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_user_insert_set_org_id` BEFORE INSERT ON `users` FOR EACH ROW BEGIN
    -- Set the new user's org_id using the stored function
    SET NEW.org_id = GetOrganizationIdByUnpkChain(NEW.unpk);
END */;;
DELIMITER ;
...
-- Dump completed on 2026-01-16 22:28:19
