...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4901d208-f29b-11f0-993e-2c58b9de6848:1-1628';
...
CREATE TABLE `asset_requests` (
  ...
  `request_type` enum('Repair','Replacement','New Asset','Supervisor Request') NOT NULL,
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_chk_1` CHECK (((`role` = _utf8mb4'vendor') or (`unpk` is not null)))
...
-- Dump completed on 2026-03-15 15:23:28
